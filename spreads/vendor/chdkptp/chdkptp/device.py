...
from typing import List, Dict, Tuple, Union, Optional, Generator, Any

from .lua import LuaContext, global_lua, parse_table
from . import util

from lupa import LuaError


DISTANCE_RE = re.compile(r'(\d+(?:.\d+)?)(mm|cm|m|ft|in)')
DISTANCE_FACTORS = {
    'mm': 1,
    'cm': 100,
    'm': 1000,
